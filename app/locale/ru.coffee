...
#    hero_blurb_2: "Premium Warriors unlock stunning martial skills like Warcry, Stomp, and Hurl Enemy. Or, play as a Ranger, using stealth and bows, throwing knives, traps! Try your skill as a true coding Wizard, and unleash a powerful array of Primordial, Necromantic or Elemental magic!"
    ...
    pet_blurb_1: "Животные - это не только обожаемые компаньоны, они, также, дают уникальные возможности и методы. Например: маленький Грифон может летать вокруг препятствий, помогая герою, Волчонок может добывать лекарства, а Пума может разговаривать!"
    pet_blurb_2: "Собери всех животных, чтобы открыть их уникальные возможности!"
    pet_caption: "Приручи животное, чтобы сопровождать своего героя!"
    game_dev_blurb: "Изучай программирование игры и создавай новые уровни чтобы делиться ими с друзьями! Размещай объекты по своему желанию, пиши код для логики и поведения предметов, и смотри, смогут ли твои друзья пройти этот уровень!
    ...
    list_gems: "Получай премиальные самоцветы каждый месяц чтобы покупать устройства, животных и героев"
    ...
    list_items: "Получай совершенно Премиальные предметы, например животных"
    list_support: "Получи Премиальную поддержку, чтобы исправлять сложный код"
    list_clans: "Создавай свои кланы и приглашай друзей чтобы соревноваться вместе"
